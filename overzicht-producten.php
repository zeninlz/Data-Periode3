...
<div class="container">
    <div class="table-container">
        <ul class="nav nav-pills nav-fill gap-2 p-1 small bg-primary rounded-5 shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-white);">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link rounded-5" href="reserveringen.php" aria-selected="false">Reserveringen</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link rounded-5" href="bestellingen.php" aria-selected="false">Bestellingen</a>
            </li>  
            <li class="nav-item" role="presentation">
                <a class="nav-link rounded-5" href="klanten.php" aria-selected="false">Klanten</a>
            </li>
        </ul>
